...
public class HTMLParser {
	...
	public static String parse(String htmlTxt) {
		EditorKit kit = new HTMLEditorKit();
		Document doc = kit.createDefaultDocument();
		try {
			Reader reader = new StringReader(htmlTxt);
